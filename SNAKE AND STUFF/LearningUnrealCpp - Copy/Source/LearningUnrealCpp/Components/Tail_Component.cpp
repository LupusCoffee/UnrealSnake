...
void UTail_Component::DestroyTail()
{
	GEngine->AddOnScreenDebugMessage(-1, 5.0, FColor::Blue, TEXT("DESTROYED"));
	for (auto TailObj : TailObjects)
	{
		TailObjects.Remove(TailObj);
		TailObj->Destroy(); //doesn't destroy straight away for some reason ¯\_(ツ)_/¯ i wanna figure out why. if you're reading this, teach, plz help me!!
	}
}
